...
- 회원가입/로그인 후 게시글과 게시글에 대한 댓글을 **작성/수정/삭제**할 수 있는 앱
...
| 진행사항 | 진행기간 | 세부사항 |
|:---:| :--- | :--- |
| UI 개발 | 2021.12.31 | 앱 전체적인 View 개발 |
| Auth 기능 개발 | 2022.01.03 | 회원가입 및 로그인 기능 개발 |
| Post, Comment 기능 개발 | 2022.01.04~22.01.06 | Post, Comment CRUD 개발 |
